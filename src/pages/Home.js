            ...
            <div className="welcomeDiv" >
                <div style={{ display: "flex", justifyContent: "space-around", }}>
                    <div className="titleDiv">
                        <label className="mainHeading">Welcome to the<br /> Student Profile Portal</label>
                        <label className="subHeadingsProfile">Build your profile Now</label>
                        <Button style={{ background: "#293E6F", color: "#FFF", width: "200px", fontSize: "20px", marginTop: "2%", border: "none" }} onClick={() => { history.push('/sign-in'); }}>Login</Button>
                        <br />
                    </div>
